  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        bs9: "0px 1px  2px 0px #0000000f",
        bs2: "0px 4px  4px 0px #0000003f",
        bs4: "-2px 0px  1px 0px #0000003f",
        bs: "0px 4px  4px 0px #00000019",
        bs8: "-5px 6px  2px 0px #0000003f",
        bs7: "0px 10px  10px -5px #0000000a",
        bs5: "3px 4px  4px 0px #00000019",
        bs6: "0px 13px  19px 0px #00000011",
        bs1: "-17px 28px  32px 0px #0000007f",
      },
      textShadow: { ts: "0px 2px  4px #00000019" },
      backgroundImage: {
        gradient: "linear-gradient(89deg ,#0000009e,#0000009e,#0000009e)",
        gradient1: "linear-gradient(145deg ,#fafafa33,#ffffff19,#fafafa00)",
        gradient2: "linear-gradient(180deg ,#ffe800,#4f0166)",
